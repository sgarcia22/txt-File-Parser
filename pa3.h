    ...
    public:
        ...
        pa3 (string fileName) {
            ...
            if (!(userFile.is_open())) {
                ...
                //Takes char until it reaches the end of file
                while (!(userFile >> word).eof()) {
                    //Concatenates the chars into a temporary string
                    temp += word;

                }
                //Pushes the string into the totalFile vector to later parse
        ...
        void tokenizeString(string input) {
            ...
            for (unsigned int i = 0; i < input.size(); ++i) {
                ...
                if ((input[i] != ('a')) || (input[i] != ('b')) || (input[i] != ('c')) || (input[i] != ('d')) || (input[i] != ('e'))
                    ...
                    || (input[i] != ('z')) || (input[i] != ('A')) || (input[i] != ('B')) || (input[i] != ('C')) || (input[i] != ('D'))
                    || (input[i] != ('E')) || (input[i] != ('F')) || (input[i] != ('G')) || (input[i] != ('H')) || (input[i] != ('I'))
                    || (input[i] != ('J')) || (input[i] != ('K')) || (input[i] != ('L')) || (input[i] != ('M')) || (input[i] != ('N'))
                    || (input[i] != ('O')) || (input[i] != ('P')) || (input[i] != ('Q')) || (input[i] != ('R')) || (input[i] != ('S'))
                    || (input[i] != ('T')) || (input[i] != ('U')) || (input[i] != ('V')) || (input[i] != ('W')) || (input[i] != ('X'))
                    || (input[i] != ('Y')) || (input[i] != ('Z'))) {
                ...
                if ((input[i] == ('a')) || (input[i] == ('b')) || (input[i] == ('c')) || (input[i] == ('d')) || (input[i] == ('e'))
                    ...
                    while (i < input.size()) {
                        ...
                        if (islower(input[i])) {
                            ...
                            tempConstantUpper += input[i];
                            if (tempConstantUpper == "BEGIN" || tempConstantUpper == "FOR" || tempConstantUpper == "END") {
                                temp.push_back(tempConstantUpper);
                                stackImplementation::push(tempConstantUpper,  keywords);
                                tempConstantUpper.clear();
                                parsed = true; }
                        }
                        else {
                            if (i != 0) {
                    ...
                    if (!(tempConstant.empty())) {
                     ...
                     if (!(tempConstantUpper.empty())) {
                        if (tempConstantUpper == "BEGIN" || tempConstantUpper == "FOR" || tempConstantUpper == "END") {
                            ...
                            stackImplementation::push(tempConstantUpper,  wrongInput);
                            tempConstantUpper.clear();
                            parsed = true;
                        }
